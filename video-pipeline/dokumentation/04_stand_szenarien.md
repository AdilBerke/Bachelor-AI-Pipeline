...
| `rabbit_lake` | 9 | vor Absturz | Nur bis Round 5 dokumentiert | **Nein** — Rescue-Plan-Phase 2 nie erreicht | Blockiert: Grundproblem (3 statt 2 Figuren) ungelöst; Round 9 endete mit CUDA-OOM-Absturz |
...
- `rabbit_lake` eignet sich nicht als "fertiges" Beispiel, ist aber als **dokumentierter
  ...
  sich mit wenig LoRA-Daten nicht zuverlässig überschreiben — siehe
